...
<div class="offcanvas offcanvas-end  border-light" tabindex="-1" id="offcanvasMenu">
	<div class="offcanvas-header justify-content-end">
		<button type="button" id="closedSidebar" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
	</div>
		...
		<div>
			...
			<!-- Nav END -->
			 ...
			 <div class="d-flex flex-column justify-content-center align-items-center">
				<img class="offcanvas-avatar avatar-img p-1 mb-2"  src="{{Vite::image('vahid.jpeg')}}" alt="">
